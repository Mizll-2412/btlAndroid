      ...
      //  edpass2 = (EditText) findViewById(R.id.edPasswordIn);
        ...
        imgFb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setData(Uri.parse("https://www.facebook.com/iamngoquocminh"));
                startActivity(intent);
            }
        });
        ...
        imgIns.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setAction(Intent.ACTION_VIEW);
                intent.setData(Uri.parse("https://www.instagram.com/lilmizll/"));
                startActivity(intent);
            }
        });
        ...
        imgSms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setData(Uri.parse("sms:0326700146"));
                startActivity(intent);
            }
        });
